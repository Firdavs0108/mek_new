...
if(isset($_POST['email'])) {
  ...
  $email_subject = "[두께측정기 제품문의]".$title;
  ...
  $email_message .= "APC 적용 여부 : ".clean_string($apc)."<br><br>";
  $email_message .= "라인 상태 : ".clean_string($lineStatus)."<br><br>";
...
<script>
alert ("문의주셔서 감사합니다.\n빠른 시일안에 답변드리겠습니다.");
location.href='/home/sub04_02.php';
</script>
