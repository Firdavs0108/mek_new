        ...
        <form name="contactform" method="post" action="/home/sub04_02_send.php" enctype="multipart/form-data" class="fields">
          ...
          <li>
            ...
            <li>
              ...
              <li id="apc_area">
                <span id="apply_apc" class="lbl required">APC 적용 여부</span>
                <div class="desc flex ">
                  <input name="apc" type="radio" id="apcOn" class="input full check" value="APC 적용">APC 적용
                  <input name="apc" type="radio" id="apcOff" class="input full check" value="APC 미적용">APC 미적용
                </div>
              </li>
              <li id="line_area">
                <span id="line_status" class="lbl required">라인 상태</span>
                <div class="desc flex ">
                  <input name="lineStatus" type="radio" id="apcOn" class="input full check" value="신규 라인">신규 라인
                  <input name="lineStatus" type="radio" id="apcOff" class="input full check" value="기존 라인">기존 라인
                </div>
              </li>
