    ...
    <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
           ...
           <!-- <li><input type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" class="btn btn_b01"></li>
			...
			<li><a href="javascript:select_move('prev');" class="btn_b02 btn">아래로 이동</a></li>
			<li><a href="javascript:select_move('change');" class="btn_b02 btn">교차 변경</a></li>
			<li><a href="javascript:select_move('next');" class="btn_b02 btn">위로 이동</a></li>
            <?php } ?>
